/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config wrangler.jsonc` (hash: 6277671d9293f8b723c6bf4f47697362)
// Runtime types generated with workerd@1.20260430.1 2026-04-30 nodejs_compat,nodejs_compat_populate_process_env
declare namespace Cloudflare {
	interface Env {
		PERPS_BENCH_API_URL: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PERPS_BENCH_API_URL" | "PERPS_BENCH_API_USER" | "PERPS_BENCH_PUBLIC_SITE_URL" | "PERPS_BENCH_API_PASSWORD">> {}
}
