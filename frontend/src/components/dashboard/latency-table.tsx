...
import { confirmP50, confirmP95, primaryLabel } from "@/lib/latency-metric"
        ...
        <table className="w-full min-w-[760px] border-collapse text-left text-[11px]">
          <thead className="bg-surface-2 text-muted-foreground">
            <tr>
              ...
              <HeaderCell align="right">Displayed p50</HeaderCell>
              <HeaderCell align="right">Displayed p95</HeaderCell>
            ...
            {rows.length === 0 ? (
              ...
              rows.map((row) => (
                ...
                >
                  ...
                  <BodyCell align="right">{formatLatency(row.speed_bump_ms)}</BodyCell>
