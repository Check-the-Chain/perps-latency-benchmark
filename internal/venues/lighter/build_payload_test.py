...
class SignerClientStub:
    ...
    def sign_create_order(self, **kwargs):
        ...
        self.__class__.orders.append(kwargs)
...
class LighterStub:
    ...
    class AccountApi:
        ...
        def account_limits(self, **_kwargs):
            return {"user_tier_name": "premium", "effective_lit_stakes": 0}
...
class LighterBuildPayloadTest(unittest.TestCase):
    ...
    def test_market_order_metadata_and_ws_body(self):
        ...
        self.assertEqual(built["metadata"]["speed_bump_ms"], 200)
    ...
    def test_lighter_taker_latency_tiers(self):
        self.assertEqual(build_payload.lighter_taker_latency_ms("standard", 500_000), 300)
        self.assertEqual(build_payload.lighter_taker_latency_ms("premium", 0), 200)
        self.assertEqual(build_payload.lighter_taker_latency_ms("premium", 500_000), 140)
    ...
    def test_batch_uses_price_ladder(self):
        ...
        self.assertEqual(built["metadata"]["orders"], 3)
        self.assertEqual([order["price"] for order in SignerClientStub.orders], [750000, 749990, 749980])
